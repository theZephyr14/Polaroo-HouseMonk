...
// Test with the master token you provided directly
async function testMasterTokenProvided() {
  console.log("🧪 TESTING WITH PROVIDED MASTER TOKEN");
  console.log("=".repeat(50));
  console.log("⚠️  NO INVOICES WILL BE CREATED");
  console.log("=".repeat(50));
  
  // Use the master token you provided
